  ...
  function renderSetup(root) {
    ...
    root.innerHTML =
      ...
      "<div class=\"stack\">" +
        ...
        "<button class=\"card card-button\" data-exam=\"start\" data-mode=\"messerA\"><strong>Professor Messer Exam A</strong><span class=\"muted\" style=\"display:block;margin-top:6px\">90 minutes · " + (typeof QuestionBank !== "undefined" ? QuestionBank.examLine("A") : counts.A + " items") + "</span></button>" +
        "<button class=\"card card-button\" data-exam=\"start\" data-mode=\"messerB\"><strong>Professor Messer Exam B</strong><span class=\"muted\" style=\"display:block;margin-top:6px\">90 minutes · " + (typeof QuestionBank !== "undefined" ? QuestionBank.examLine("B") : counts.B + " items") + "</span></button>" +
        "<button class=\"card card-button\" data-exam=\"start\" data-mode=\"messerC\"><strong>Professor Messer Exam C</strong><span class=\"muted\" style=\"display:block;margin-top:6px\">90 minutes · " + (typeof QuestionBank !== "undefined" ? QuestionBank.examLine("C") : counts.C + " items") + "</span></button>" +
